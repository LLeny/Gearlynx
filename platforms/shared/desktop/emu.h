...
EXTERN bool emu_is_rewind_enabled(void);
EXTERN int emu_get_rewind_buffer_capacity(void);
EXTERN int emu_get_rewind_frame_count(void);
EXTERN int emu_get_rewind_target_offset(void);
EXTERN u64 emu_get_rewind_target_frame_number(void);
EXTERN void emu_set_rewind_target_offset(int offset);
EXTERN bool emu_preview_rewind_target(int offset);
EXTERN bool emu_apply_rewind_target(void);
EXTERN void emu_reset_rewind_buffer(void);
